...
const fetch = require('node-fetch'); // For making HTTP requests (like to ipapi.co and EmailJS)

const app = express();
const PORT = process.env.PORT || 3000;

// Middleware
app.use(cors()); // Allows requests from different origins (e.g., your frontend)
app.use(express.json()); // Parses JSON bodies of incoming requests

// Serve static files from the 'public' directory
// This means index.html, style.css, script.js, background.mp4 will be served from here
